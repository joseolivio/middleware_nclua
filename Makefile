...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/build-aux/Makefile.am.gitlog \
...
WERROR_CFLAGS = 
WINDRES = 
abs_builddir = /home/osboxes/Desktop/nclua
abs_srcdir = /home/osboxes/Desktop/nclua
...
DISTCLEANFILES = config.cache $(NULL)
EXTRA_DIST = .version README.md bootstrap build-aux/git-log-fix \
	build-aux/git-version-gen build-aux/gitlog-to-changelog \
	build-aux/manywarnings.m4 build-aux/perl.m4 \
	build-aux/syntax-check-copyright build-aux/syntax-check \
	build-aux/useless-if-before-free build-aux/util.m4 \
	build-aux/warnings.m4 build-aux/libcurl.m4 maint.mk $(NULL) \
	$(am__append_3)
MAINTAINERCLEANFILES = Makefile.in .version ChangeLog INSTALL \
	...
	build-aux/test-driver build-aux/libcurl.m4 configure \
	lib/config.h.in lib/config.h.in~ $(NULL)
...
# Setup version.
BUILT_SOURCES = .version $(am__append_1)
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/build-aux/Makefile.am.common $(top_srcdir)/build-aux/Makefile.am.coverage $(top_srcdir)/build-aux/Makefile.am.gitlog $(am__configure_deps)
	@for dep in $?; do \
...
$(top_srcdir)/build-aux/Makefile.am.common $(top_srcdir)/build-aux/Makefile.am.coverage $(top_srcdir)/build-aux/Makefile.am.gitlog $(am__empty):
